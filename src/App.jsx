      ...
      <div style={{ width: '100%', minHeight: '100vh' }} className='d-flex justify-content-center align-items-center bg-dark'>
        <div style={{ width: '600px' }} className='bg-light rounded p-5'>
          ...
          <form className='mt-5'>
            ...
            {/* Principle */}
            <div className='mb-3'>
              <TextField name='principle' onChange={(e) => validateInputs(e.target)} id="outlined-basic" label="Principle Amount" variant="outlined" style={{ width: '100%' }} />
            </div>
            ...
            {/* Rate */}
            <div className='mb-3'>
              <TextField name='rate' onChange={(e) => validateInputs(e.target)} id="outlined-basic" label="Rate of Interest (%)" variant="outlined" style={{ width: '100%' }} />
            </div>
            ...
            {/* Year */}
            <div className='mb-3'>
              <TextField name='year' onChange={(e) => validateInputs(e.target)} id="outlined-basic" label="Time Period (Yr)" variant="outlined" style={{ width: '100%' }} />
            </div>
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Button onClick={handelrest}  variant="outlined" style={{ width: '50%', height: '70px' }}>RESET</Button>
